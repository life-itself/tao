...
* Social media - Remove team member's admin/editor/team access from Life Itself's social media accounts (X, LinkedIn, Instagram, Facebook, YouTube). See the offboarding skill in the ops repo (https://github.com/life-itself/ops/blob/main/.claude/skills/offboarding/SKILL.md) for the platform-by-platform checklist.
